...
import {MeshConfigDetailComponent} from './component';
...
describe('MeshConfigDetailComponent', () => {
  let httpMock: HttpTestingController;
  let configService: ConfigService;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ObjectMetaComponent, MaxiTestComponent, CardComponent, PropertyComponent, MeshConfigDetailComponent],
      imports: [
        MatIconModule,
        MatCardModule,
        MatDividerModule,
